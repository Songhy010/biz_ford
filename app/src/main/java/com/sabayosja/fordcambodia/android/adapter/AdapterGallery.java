...
public class AdapterGallery extends RecyclerView.Adapter<AdapterGallery.ItemHolder> {

    private final Context context;
    private final JSONArray array;

    public AdapterGallery(Context context, JSONArray array) {
    ...
    public ItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view.getLayoutParams().width = width / 2 - 50 ;
