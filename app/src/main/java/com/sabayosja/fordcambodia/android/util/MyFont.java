...
public class MyFont {
    ...
    private String getFontPath(int type) {
        int asc[];
        if (type == 1) {
            asc = new int[]{105, 116, 97, 108, 105, 99, 46, 116, 116, 102};
        } else if(type == 2) {
            asc = new int[]{108, 105, 103, 104, 116, 46, 116, 116, 102};
        }else if(type == 3){
            asc = new int[]{98, 111, 108 ,100, 46, 116 ,116 ,102};
        }else {
    ...
    public void applyFontToMenuItem(Context context, MenuItem mi) {
        Typeface font = Typeface.createFromAsset(context.getAssets(), "italic.ttf");
